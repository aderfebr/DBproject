  ...
  <div id="main">
    <div id="left">
      <ul>
        ...
        <li id="selected"><router-link to="/order"><i class="fa fa-map-marker"/>&ensp;订单</router-link></li>
        <li><router-link to="/crm"><i class="fa fa-wrench"/>&ensp;推荐系统</router-link></li>
      </ul>
    </div>
    <div id="right">
      <div id="top">
        <ul>
          <li><h1>&ensp;<i class="fa fa-map-marker"/>&ensp;订单</h1></li>
        </ul>
...
export default{
  ...
  methods:{
		getdata(){
			this.axios.get('http://localhost:8000/api/orders/')
			.then(res=>{
