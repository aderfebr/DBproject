  ...
  <div id="main">
    <div id="left">
      <ul>
        ...
        <li id="selected"><router-link to="/tiaopei"><i class="fa fa-wrench"/>&ensp;调配构成表</router-link></li>
    ...
    <div id="right">
      <div id="top">
        <ul>
          <li><h1>&ensp;<i class="fa fa-wrench"/>&ensp;调配构成表</h1></li>
        </ul>
...
export default{
  ...
  methods:{
		getdata(){
			this.axios.get('http://localhost:8000/api/tiaopei/')
			.then(res=>{
