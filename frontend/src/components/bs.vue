<template>
  <div id="main">
    ...
    <div id="right">
      <div id="top">
        <ul>
          <li><h1>&ensp;<i class="fa fa-archive"/>&ensp;资产负债表</h1></li>
          <li><router-link to="/query_bs"><button id="add">查询</button></router-link></li>
        </ul>
...
export default{
  ...
  methods:{
		getdata(){
			this.axios.get('http://localhost:8000/api/bs/')
			.then(res=>{
