<template>
  <div id="main">
    ...
    <div id="right">
      <div id="top">
        <ul>
          <li><h1>&ensp;<i class="fa fa-archive"/>&ensp;计算结果</h1></li>
          <li><router-link to="/query_bs"><button id="clear">返回</button></router-link></li>
        </ul>
...
export default{
  ...
  methods:{
		getdata(){
			this.axios.get('http://localhost:8000/api/answer_bs/')
			.then(res=>{
